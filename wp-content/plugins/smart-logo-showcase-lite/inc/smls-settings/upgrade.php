...
<div  class="smls-upgrade-wrapper">
    <a href="https://codecanyon.net/item/smart-logo-showcase-responsive-clients-logo-gallery-plugin-for-wordpress/19274075?ref=AccessKeys" target="_blank"><img src="<?php echo SMLS_IMG_DIR; ?>/upgrade-250.jpg" alt="<?php _e( 'Upgrade Smart Logo Showcase', SMLS_TD ); ?>"></a>
    ...
    <a href="https://codecanyon.net/item/smart-logo-showcase-responsive-clients-logo-gallery-plugin-for-wordpress/19274075?ref=AccessKeys" target="_blank"><img style="width:100%;" src="<?php echo SMLS_IMG_DIR; ?>/feature.jpg" alt="<?php _e( 'Smart Logo Showcase Features', SMLS_TD ); ?>"></a>
</div>
