=== Remove Version ===
Contributors: barry.ko
Plugin Name: Remove Version
Plugin URI: http://www.barryko.com/
Tags: version, remove, delete, hide, wordpress version, wordpress
...
1. Upload `remver.php` to the `/wp-content/plugins/` directory
...
http://www.barryko.com/code/remove-wordpress-version/

== Plugin Support ==

[Remove WordPress Version Developer](http://www.barryko.com/ "Search and Media Technologist")
