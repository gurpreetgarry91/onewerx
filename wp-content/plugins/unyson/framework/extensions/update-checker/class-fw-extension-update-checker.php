...
class FW_Extension_Update_Checker extends FW_Extension {
    ...
    /**
     * Cookie name for redirekt param.
     *
     * @var        string
     */
    const REDIRECTED_COOKIE = 'crumina_redirected_to_activate';
     ...
     * @var        string
     */
    const OPTIONS_SLUG = 'crumina_activate_options';
     ...
     * @var        string
     */
    const OPTION_USERNAME_SLUG = 'envato_username';
     ...
     * @var        string
     */
    const OPTION_APIKEY_SLUG = 'envato_apikey';
     ...
     * @var        string
     */
    const OPTION_REVOKE_SLUG = 'crumina_envato_revoke';
     ...
     * @var        string
     */
    const OPTION_UPDATE_TOKEN_SLUG = 'crumina_update_token';
     ...
     * @var        string
     */
    const PAGE_SLUG = 'crumina_activate_theme';
    ...
    public function activationNotice() {
        ...
        add_action( 'admin_notices', function () {
            echo '<div class="notice notice-error is-dismissible"><p>' . __( 'Check theme activation. To get automatic updates and other features.', 'fw' );
    ...
    public function renderPageTemplate() {
        ...
        wp_enqueue_style( 'activate-theme-page', $this->locate_URI( '/static/css/activate-theme-page.css' ), false, $this->manifest->get_version() );
