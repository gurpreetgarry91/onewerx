...
<div class="<?php echo esc_attr($itemsize)?> row-view">
	...
	<?php the_content(); ?>
        <div class="portfolio-filter-wrap   <?php echo esc_attr($itemsize)?> animated " data-animation="bounceInRight"  >
        
        <div id="portfolio" class="portfolio-point"></div>
        
          <ul class="portfolio-filter <?php echo ' non-paginated' ?>">
			
				<li><a href="#" class="active" data-filter="*"><?php _e('Show All', 'PixTheme')?></a></li>
				<?php 
...
<?php 	if ($wp_query->have_posts()): 
    		while ($wp_query->have_posts()) : 							
						$wp_query->the_post(); ?>
	<div class="portfolio-modal modal fade" id="myModal<?php echo esc_attr($post->ID); ?>"  >
