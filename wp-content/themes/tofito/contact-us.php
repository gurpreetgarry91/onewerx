...
<?php 
	...
	//$breadcrumbs = $pix_options['pix_show_breadcrumbs'];
	$titles = 0; //$pix_options['pix_show_page_titles'];
?>
...
<div class="container">  
  <div class="row contact-row">
    <div class="col-xs-12 col-sm-12 col-lg-6">
      <form method="POST"  class="form-full-width contact-form contactForm" id="contact-form">
        <div id="status"></div>
        <div class="row"> 
          ...
          <div class="col-xs-12 col-sm-12 text-right">
            <div class="wrap-main text-right">
