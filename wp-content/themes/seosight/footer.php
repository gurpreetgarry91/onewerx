            ...
            <div class="<?php echo esc_attr( $desc_columns_class ) ?>">
                <?php if ( ! empty( $description_title ) || ! empty( $description_text ) ) { ?>
                    <div class="crumina-heading widget-heading">
                        <?php if ( ! empty( $description_title ) ) { ?>
                            <h4 class="heading-title"  itemprop="name"><?php echo esc_html( $description_title ) ?></h4>
                ...
                <?php if ( ! empty( $description_socials ) && is_array( $description_socials ) ) { ?>
                    <div class="socials">
                        ...
                        <?php foreach ( $description_socials as $social ) {
                            echo '<a href="' . esc_url( $social['link'] ) . '" class="social__item" target="_blank" itemprop="sameAs">';
                            echo '<img src="' . get_template_directory_uri() . '/svg/socials/' . esc_attr( $social['icon'] ) . '" alt="">';
                            echo '</a>';
                        } ?>
                    </div>
                <?php } ?>
