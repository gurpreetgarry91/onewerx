...
$options = array(
    ...
    'section_sticky' => array(
	    'title'   => esc_html__( 'Sticky Header', 'seosight' ),
	    'options' => array(
		    'sticky_header' => array(
			    'type'    => 'multi-picker',
			    'label'   => false,
			    ...
			    'picker'  => array(
				    'value' => array(
					    'label'        => esc_html__( 'Show sticky header?', 'seosight' ),
					    'desc'         => esc_html__( 'Show header sticky to top on page scroll', 'seosight' ),
					    'type'         => 'switch',
					    'right-choice' => array(
						    'value' => 'yes',
						    'label' => esc_html__( 'Show', 'seosight' )
			    ...
			    'choices' => array(
				    'yes' => array(
					    'style' => array(
						    'type'    => 'select',
						    'value'   => 'swing',
						    'label'   => esc_html__( 'Animations', 'seosight' ),
						    'desc'    => esc_html__( 'Header animation when it become sticky', 'seosight' ),
						    'choices' => array(
							    'swing'  => 'Swing',
							    'slide'  => 'Slide',
							    'flip'   => 'Flip',
			...
			'aside-panel' => array(
				...
				'choices' => array(
					'yes' => array(
						'mobile' => array(
							'type'  => 'switch',
							'label' => esc_html__( 'Show on mobile?', 'seosight' ),
							'desc'  => esc_html__( 'Show button for opening aside panel on small screens', 'seosight' ),
							'value' => false,
						),
						'logo' => array(
							'type'  => 'switch',
