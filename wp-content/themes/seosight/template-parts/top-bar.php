...
if ( function_exists( 'fw_get_db_customizer_option' ) ) {
    ...
    ?>
    <div class="top-bar <?php echo $data['theme-style']; ?>">
        <div class="container">
            ...
            <div class="top-bar-contact">
                ...
                if ( ( fw_akg( 'show-languages/status', $data ) == 'show' )
                    ...
                    <div class="contact-item">
                        <img src="<?php echo $lang_img; ?>" class="flags" alt="">
                    ...
                    <div class="socials">
                        <?php foreach ( $data['social-networks'] as $social ) { ?>
                            <a href="<?php echo esc_html( $social['link'] ); ?>" target="_blank" class="social__item">
                                <img src="<?php echo get_template_directory_uri() . '/svg/socials/' . $social['icon']; ?>"
                                     alt="<?php trim( $social['icon'], '.svg' ) ?>">
                            </a>
                        <?php } ?>
                    </div>
                </div>
