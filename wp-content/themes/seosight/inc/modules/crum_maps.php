				...
				'params'      => array(
					'general' => array(
						...
						array(
							...
							'name'        => 'map_location',
							'description' => wp_kses( __( 'Go to <a href="https://www.google.com/maps/" target=_blank>Google Maps</a> and search your Location. Click on menu near search text => Share or embed map => Embed map. Next copy iframe to this field', 'seosight' ), array(
								'a' => array(
									'href'   => true,
									'target' => true,
								),
						...
						array(
							...
							'description' => '<a href="https://developers.google.com/maps/documentation/javascript/get-api-key">' . esc_html__( 'Instruction to create API key', 'seosight' ) . '</a>',
							'relation'    => array(
								'parent'    => 'google_js',
								'show_when' => 'yes'
							)
