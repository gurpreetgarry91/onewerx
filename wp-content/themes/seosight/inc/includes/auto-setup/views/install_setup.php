...
<div class="wrap">
	...
	<div class="postbox auto-setup-box plugins-and-demo">
		...
		<div class="actions">
			<a class="button button-primary"
			   href="<?php echo $import_demo_content_url; ?>"><?php esc_html_e( 'Install Plugins & Demo Content', 'seosight' ) ?></a>
	...
	<div class="postbox auto-setup-box plugins-only">
		...
		<div class="actions">
			<a class="button button-primary"
			   href="<?php echo $install_dependencies_url; ?>"><?php esc_html_e( 'Install Plugins Only', 'seosight' ) ?></a>
	...
	<div class="postbox auto-setup-box skip-auto-setup">
		...
		<div class="actions">
			<a class="button button-secondary"
			   href="<?php echo $skip_auto_install_url; ?>"><?php esc_html_e( 'Skip Auto Setup', 'seosight' ) ?></a>
