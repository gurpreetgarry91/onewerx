 ...
 class Seosight_Widget_Latest_News extends WP_Widget {
	...
	function form( $instance ) {
		...
		<p>
			...
			<input type="text" value="<?php echo esc_attr( $text_button ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'text_button' ) ); ?>" id="<?php echo( $this->get_field_id( 'text_button' ) ); ?>" class="widefat"/>
		</p>
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'link_button' ) ); ?>"><?php esc_html_e( 'Button link', 'seosight' ); ?></label>
			<input type="text" value="<?php echo esc_attr( $link_button ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'link_button' ) ); ?>" id="<?php echo( $this->get_field_id( 'link_button' ) ); ?>" class="widefat"/>
		</p>
		<?php
	}
}
